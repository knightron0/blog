    ...
    <>
      <section className='mb-10'>
        ...
        <ul className="mt-1 ml-4 list-disc space-y-1 pl-6">
          ...
          <li>The definition of "work" changed has <Link href="https://www.linkedin.com/posts/scott-wu-8b94ab96_picture-one-of-your-ancestors-from-hundreds-share-7488289761728831489-u9IH/">changed so much in the past century</Link>. In a post-AGI world, <Link href="https://charlesponeill.com/posts/final-form-of-work/">how will this evolve</Link>?</li> 
          <li>How would <Link href="https://www.anthropic.com/institute/recursive-self-improvement">RSI</Link> work if future progress requires a fundamental paradigm shift? If both us/models are stuck in local optimums, would we need new core learning theories? Ones that are OOMs more sample efficient?</li>
          <li>This is on a lot of minds at the moment, but how can we avoid <Link href="https://x.com/sama/status/2099352016988614852">these</Link> <Link href="https://darioamodei.com/post/we-must-pace-the-frontier">scenarios</Link>? How is alignment best tackled: scientifically, institutionally, or through government?</li>
        </ul>
        <br />
